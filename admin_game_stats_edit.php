        ...
        <div style="display:grid; grid-template-columns:1fr; gap:2rem;">
            ...
            <div class="admin-form-card" style="background: white; border-radius: 12px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); height: fit-content;">
                <h3 style="margin-bottom: 20px; color: #333; border-bottom: 2px solid var(--primary); padding-bottom: 10px; display: inline-block;">
                    <i class="fas fa-plus-circle" style="color:var(--primary); margin-right:8px;"></i>新增球員詳細數據
                </h3>
                    ...
                    <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <select name="player_id" class="form-control" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                            ...
                            <?php foreach($players as $p): ?>
                                <option value="<?= $p['Player_id'] ?>"><?= htmlspecialchars($p['Player_Name']) ?> <?= $p['jersey_number'] ? '(#'.$p['jersey_number'].')' : '' ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:20px;">
                        ...
                        <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #eee;">
                            ...
                            <div class="form-group" style="margin-bottom:15px;">
                                ...
                                <input type="number" name="pa_count" min="0" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                            </div>
                            <div class="form-group" style="margin-bottom:15px;">
                                <label style="display:block; margin-bottom:8px; font-weight:500; color:#555; font-size:0.95rem;">打席結果 (例如: 1B, 2B, GO, SO)</label>
                                <input type="text" name="pa_results" placeholder="輸入結果" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                            </div>
                        </div>
                        ...
                        <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #eee;">
                            ...
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:15px; margin-bottom:15px;">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pitches" min="0" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                                </div>
                                <div class="form-group">
                                    <label style="display:block; margin-bottom:8px; font-weight:500; color:#555; font-size:0.95rem;">局數 (如: 1.1)</label>
                                    <input type="text" name="innings" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                                </div>
                            </div>
                            <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:15px;">
                                <div class="form-group">
                                    <label style="display:block; margin-bottom:8px; font-weight:500; color:#555; font-size:0.95rem;">三振</label>
                                    <input type="number" name="strikeouts" min="0" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                                </div>
                                <div class="form-group">
                                    <label style="display:block; margin-bottom:8px; font-weight:500; color:#555; font-size:0.95rem;">保送</label>
                                    <input type="number" name="walks" min="0" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                                </div>
                                <div class="form-group">
                                    <label style="display:block; margin-bottom:8px; font-weight:500; color:#555; font-size:0.95rem;">責失分</label>
                                    <input type="number" name="earned_runs" min="0" value="0" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box;">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php else: ?>
                            ...
                            <tr style="border-bottom: 1px solid #eee; transition: background 0.3s; vertical-align: middle;">
                                ...
                                <td style="padding: 12px 15px; text-align: center; white-space: nowrap;">
                                    <form method="POST" action="" onsubmit="return confirm('確定要刪除這筆數據嗎？');" style="display:inline-block;">
