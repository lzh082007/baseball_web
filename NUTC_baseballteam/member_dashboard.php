    ...
    <div class="container">
        <div class="member-dashboard-layout">
            ...
            <div>
                ...
                <div class="section-title member-section-title">
                    <h2>AI 戰報推播</h2>
                    <p>Insights Generated by AI for Recent Matches</p>
                </div>

                <div class="ai-report-card">
                    <div class="ai-report-content">
                        <div class="ai-report-icon-box">
                            <i class="fas fa-bolt"></i>
                        </div>
                        <div class="ai-report-text">
                            <h3>本週戰報摘要：vs 逢甲大學</h3>
                            <p>
                                本次比賽整體打線在第三局爆發，單局得 6 分。黃郁婷投手表現穩健，撐過 5 局僅失 2 分自責分。捕手劉詠傑配球靈活成功壓制對方強打者，是本次獲勝的決勝關鍵！
                            </p>
                            <a href="matches.php" class="ai-report-link">閱讀完整詳細戰報 <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
